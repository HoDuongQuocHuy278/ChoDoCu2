export const banks = [
    ...
    { bin: '970437', shortName: 'HDBank', name: 'Ngân hàng TMCP Phát triển TPHCM' },
    ...
    { bin: '970446', shortName: 'CAKE', name: 'Ngân hàng số Cake by VPBank' },
    { bin: '970452', shortName: 'Ubank', name: 'Ngân hàng số Ubank by VPBank' },
    { bin: '963388', shortName: 'Timo', name: 'Ngân hàng số Timo' },
    { bin: '970449', shortName: 'LienVietPostBank', name: 'Ngân hàng TMCP Bưu Điện Liên Việt' },
    ...
    { bin: '970414', shortName: 'OceanBank', name: 'Ngân hàng TMCP Đại Dương' },
    { bin: '970428', shortName: 'NamABank', name: 'Ngân hàng TMCP Nam Á' },
    { bin: '970430', shortName: 'PGBank', name: 'Ngân hàng TMCP Xăng dầu Petrolimex' },
    { bin: '970419', shortName: 'NCB', name: 'Ngân hàng TMCP Quốc Dân' },
    { bin: '970434', shortName: 'VietBank', name: 'Ngân hàng TMCP Việt Nam Thương Tín' },
    { bin: '970458', shortName: 'BaoVietBank', name: 'Ngân hàng TMCP Bảo Việt' },
    { bin: '970400', shortName: 'SaigonBank', name: 'Ngân hàng TMCP Sài Gòn Công Thương' },
    { bin: '970457', shortName: 'Woori', name: 'Ngân hàng Woori Bank tại Việt Nam' },
    { bin: '970424', shortName: 'ShinhanBank', name: 'Ngân hàng Shinhan Việt Nam' },
    { bin: '970438', shortName: 'BIDC', name: 'Ngân hàng Đầu tư và Phát triển Campuchia - Chi nhánh TP.HCM' },
]
