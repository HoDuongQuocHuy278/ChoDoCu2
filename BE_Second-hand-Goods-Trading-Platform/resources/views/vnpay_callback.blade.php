    ...
    <div class="callback-container">
        ...
        <div class="info-card">
            ...
            <div class="info-row">
                ...
                <span class="info-value"><strong>{{ $order_code }}</strong></span>
            </div>
            @endif

            @if(isset($vnp_TransactionNo))
            <div class="info-row">
            ...
            <div class="info-row">
                ...
                <span class="info-value"><strong>{{ number_format($vnp_Amount / 100, 0, ',', '.') }} ₫</strong></span>
            </div>
            @endif
            ...
            @if(isset($vnp_CardType))
            <div class="info-row">
                <span class="info-label">Loại thẻ:</span>
                <span class="info-value">{{ $vnp_CardType }}</span>
            </div>
            @endif

            @if(isset($vnp_PayDate))
            <div class="info-row">
            ...
            <div class="info-row">
                ...
                <span class="info-value">
                    <span class="badge {{ $vnp_ResponseCode == '00' ? 'bg-success' : 'bg-danger' }}">
                        {{ $vnp_ResponseCode }}
                    </span>
                </span>
            </div>
        ...
        <div class="info-card mt-3">
            ...
            <pre style="font-size: 12px; max-height: 200px; overflow-y: auto;">{{ json_encode($debug, JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE) }}</pre>
        </div>
        @endif
    </div>
